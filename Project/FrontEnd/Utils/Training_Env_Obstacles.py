...
exit_points = (
    pygame.Rect((width-40)/2-50,0,100,40),
    pygame.Rect((width-40)/2-50,height-40,100,40),
    pygame.Rect(0, (height-40)/2-10,100,40),
    pygame.Rect(width-100, (height-40)/2-10,100,40),
)
