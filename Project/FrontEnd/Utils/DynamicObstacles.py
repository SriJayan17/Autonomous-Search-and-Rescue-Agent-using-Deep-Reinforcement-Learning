...
dynamicVictims = [
    pygame.Rect(420,250,50,50),
    pygame.Rect(100,170,50,50),
    pygame.Rect(340,520,50,50)
]
...
dynamicObstacles = [
    ...
    pygame.Rect(550,220,20,130),
    pygame.Rect(570,220,40,20),
    pygame.Rect(610,170,20,70),
    pygame.Rect(360,80,240,20),
    pygame.Rect(480,410,220,20),
    pygame.Rect(400,290,20,140),
    pygame.Rect(250,290,150,20),
    pygame.Rect(480,220,20,200),
...
dynamicFireFlares = [
    ...
    (
    pygame.Rect(305,70,40,40),
    pygame.Rect(420,250,40,40),
    pygame.Rect(600,240,40,40),
    pygame.Rect(260,490,40,40),
    ),
    (
    pygame.Rect(305,70,40,40),
    pygame.Rect(420,250,40,40),
